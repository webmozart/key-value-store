...
[![Build Status](https://travis-ci.org/webmozart/key-value-store.svg?branch=1.0.0-beta)](https://travis-ci.org/webmozart/key-value-store)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/webmozart/key-value-store/badges/quality-score.png?b=1.0.0-beta)](https://scrutinizer-ci.com/g/webmozart/key-value-store/?branch=1.0.0-beta)
